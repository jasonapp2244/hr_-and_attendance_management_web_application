...
android {
    ...
    defaultConfig {
        ...
        // Inherited from Flutter. Watch this when push is switched on:
        // firebase_core needs at least 23, so if the toolchain's default is
        // lower the Firebase build will fail here and this is the line to pin.
