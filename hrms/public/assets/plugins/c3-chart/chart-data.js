...
/*chart-wrapper*/
		...
		var chart = c3.generate({
			bindto: '#trend-customized',
		
			data: {
				columns: [
					// Blue line
					['Revenue', 300, 300, 225, 225, 300, 300],
					// Orange line
					['Expense', 150, 150, 75, 150, 225, 225]
				],
				type: 'line',
				types: {
					Revenue: 'step',
			...
			line: {
				step: {
					type: 'step-after' // important for screenshot look
				}
			},
